...
let main =
    ...
    and rt_min = ref None and rt_max = ref None and url = ref None and status = ref None
    ...
    Arg.(parse [
        ...
        "-dump", String (function tbname -> Web.(iter ?start:!start ?stop:!stop ?rt_min:!rt_min ?rt_max:!rt_max
